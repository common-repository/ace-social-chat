 ...
 * @subpackage Ace_Social_Chat/public/partials
 */

global $product;
$gSetting = get_option('ace-whatsapp-setting-field-M');
$wTitle = ($gSetting['whatsapp_content']) ? $gSetting['whatsapp_content'] : '';
$bgcolor = ($gSetting['ace_whatsapp_btn_color']) ? $gSetting['ace_whatsapp_btn_color'] : '';
$color = ($gSetting['ace_whatsapp_txtbtn_color']) ? $gSetting['ace_whatsapp_txtbtn_color'] : '';
...
<style type="text/css">
    ...
    .chat_box {
        background-image: url(<?php echo plugin_dir_url(__DIR__) . '/images/whatsapp-bkg.png';;  ?>);
    }
            ...
            <div class="awc_mContent" id="ace_style-16">
                ...
                if ($member_query->have_posts()) {
                    while ($member_query->have_posts()) : $member_query->the_post();
                        ...
                        $member_text = get_post_meta($get_cust_id, '_ace_wtp_member_acc_', true);
                        $member_text_message= $member_text['ace_member_message'];
                        if($member_text_message !="" || !empty($member_text_message)){
                          $text=$member_text['ace_member_message'];
                        }else{
                        $text = ($gSetting['whatsapp_start_chat']);
                        }
                        if ($allDay) {
                            ...
                            <a href="<?php echo $mUrl; ?>" <?php echo $target; ?> onclick="gtag('event', 'WhatsApp', {'event_action': 'whatsapp_chat', 'event_category': 'Chat', 'event_label': 'Chat_WhatsApp'});">
                                ...
                                <div class="awc_mData tt">
                                    ...
                                    <?php if ($mClass == 'awc_offline') {
                                        ...
                                        echo $member_custom_field['ace_member_btntext'];
                                    } ?>
                                </div>
