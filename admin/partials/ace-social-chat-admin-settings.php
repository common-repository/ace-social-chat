...
$btnColor         = (isset($get_setting_value['ace_whatsapp_btn_color'])) ? $get_setting_value['ace_whatsapp_btn_color'] : '';
$txtbtnColor     = (isset($get_setting_value['ace_whatsapp_txtbtn_color'])) ? $get_setting_value['ace_whatsapp_txtbtn_color'] : '';
?>
        ...
        <form action="" method="post">
            ...
            <div class="ace-whatsapp">
                ...
                <div class="ace-whatsapp-content ace-whatsapp-txtbtncolor-field position-right">
                    <input type="color" name="whatsapp_txtbtn_color" value="<?php echo $ace_whatsapp_txtbtn_color; ?>">
                </div>
            </div>
